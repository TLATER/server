OC.L10N.register(
    ...
    "Imagemagick is in use for document preview. This is not recommended out of security concerns, see the document preview documentation here:" : "En tiu servilo, la PHP-modulo „php-imagick“ ne subtenas SVG. Por pli bona kongrueco, instalu ĝin.",
    ...
    "Add to a project" : "Aldoni al projekto",
    "Show details" : "Montri la detalojn",
    "Hide details" : "Kaŝi la detalojn",
    "Rename project" : "Alinomi la projekton",
    "Failed to rename the project" : "Malsukceso alinomi la projekton",
    "Failed to create a project" : "Malsukceso krei projekton",
    "Failed to add the item to the project" : "Malsukceso aldoni la elementon al la projekto",
    "Connect items to a project to make them easier to find" : "Konekti elementojn al projekto por faciligi ilian trovon",
