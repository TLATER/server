OC.L10N.register(
    ...
    "Enter your subscription key to increase the user limit. For more information about Nextcloud Enterprise see our website." : "사용자수 제한을 해제하기 위해 구독키를 입력하세요. 기업용 Nextcloud에 대해 자세히 알고 싶다면, 저희 웹사이트를 방문하세요.",
    ...
    "Accessing site insecurely via HTTP. You are strongly advised to set up your server to require HTTPS instead, as described in the <a href=\"{docUrl}\">security tips ↗</a>." : "사이트에 HTTP를 통해서 보안 없이 접근하고 있습니다. <a href=\"{docUrl}\">보안 팁↗</a>에서 제안하는 것처럼 HTTPS를 설정하는 것을 추천합니다.",
    ...
    "A password reset message has been sent to the e-mail address of this account. If you do not receive it, check your spam/junk folders or ask your local administrator for help." : "비밀번호 초기화 메시지가 이 계정의 이메일 주소로 발송되었습니다. 메일을 받지 못했다면, 스팸/정크 폴더를 확인하거나 로컬 관리자에게 문의하십시오.",
