OC.L10N.register(
    ...
    "Update app \"%s\" from App Store" : "Ажурирање на апликација \"%s\" од продавницата",
    ...
    "Imagemagick is in use for document preview. This is not recommended out of security concerns, see the document preview documentation here:" : "Модулот php-imagick во оваа истанца не поддржува SVG датотеки. За подобра компатибилност се препорачува да се инсталира.",
    ...
    "Couldn't reset password because the token is expired" : "Неможе да се промени лозинката бидејќи токенот е истечен.",
