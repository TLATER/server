OC.L10N.register(
    ...
    "Imagemagick is in use for document preview. This is not recommended out of security concerns, see the document preview documentation here:" : "Η ενότητα php-imagick σε αυτήν την περίπτωση δεν έχει υποστήριξη SVG. Για καλύτερη συμβατότητα, συνιστάται να το εγκαταστήσετε.",
